...
// Accordion
class gemas_Widget_Accordion extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Accordion', 'gemas' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'accordion_section',
         [
            'label' => esc_html__( 'Accordion', 'gemas' ),
      ...
      $this->add_control(
         'accordion_list',
         [
            'label' => __( 'Accordion list', 'gemas' ),
            'type' => \Elementor\Controls_Manager::REPEATER,
            'fields' => $accordion->get_controls(),
            'default' => [
               [
                  'title' => __( 'Lorem ipsum dummy text used here?', 'gemas' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'gemas' )
               ],
               [
                  'title' => __( 'Why i should buy this Theme?', 'gemas' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'gemas' )
               ],
               [
                  'title' => __( 'Can i change any elements easilly?', 'gemas' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'gemas' )
               ]
            ],
            'title_field' => '{{{ title }}}',
...
Plugin::instance()->widgets_manager->register_widget_type( new gemas_Widget_Accordion );