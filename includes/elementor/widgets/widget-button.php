...
// Button
class gemas_Widget_Button extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Button', 'gemas' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->add_control(
         'align',
         [
            'label' => __( 'Align', 'gemas' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'default' => 'left',
            'options' => [
               'center'  => __( 'Center', 'gemas' ),
               'left' => __( 'Left', 'gemas' ),
               'right' => __( 'Right', 'gemas' )
            ],
         ]
      );
   ...
   protected function render( $instance = [] ) {
      ...
      <div class="gemas-btn <?php if( $settings['color'] == 'yes' ){ echo 'alt-color';} ?>" style="text-align: <?php echo esc_attr($settings['align']) ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new gemas_Widget_Button );