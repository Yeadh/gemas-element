...
// Product
class gemas_Widget_Product extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Products', 'gemas' );
   }
...
Plugin::instance()->widgets_manager->register_widget_type( new gemas_Widget_Product );