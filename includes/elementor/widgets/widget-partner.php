...
// Title
class gemas_Widget_Partner extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Partner', 'gemas' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'partner_section',
         [
            'label' => esc_html__( 'partner', 'gemas' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new gemas_Widget_Partner );