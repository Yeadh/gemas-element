...
class gemas_Widget_New extends Widget_Base {
   ...
   protected function render( $instance = [] ) {
      ...
      <ul>
          ...
          <li>
              <a class="site-preview" href="<?php the_permalink() ?>"><img src="<?php echo esc_url( get_post_meta( get_the_ID(), 'gemas_thumb', 1 ), 'makplus-120x120' ); ?>" data-preview-url="<?php echo get_the_post_thumbnail_url( get_the_ID(),'full') ?>"
