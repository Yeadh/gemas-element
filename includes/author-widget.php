 ...
 * @package gemas
 */
if( !class_exists('gemas_Author') ){
	class gemas_Author extends WP_Widget{
		/**
		...
		function __construct(){
			...
			$widget_options = array(
				'description'					=> esc_html__('gemas author here', 'gemas'), 
				'customize_selective_refresh' 	=> true,
			);

			parent:: __construct('gemas_Author', esc_html__( 'Author : gemas', 'gemas'), $widget_options );
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'About Author','gemas' );
		$profile_image = ( ! empty( $instance['profile_image'] ) ) ? $instance['profile_image'] : '';
		$designation = ( ! empty( $instance['designation'] ) ) ? $instance['designation'] : esc_html__( 'Markplus CEO','gemas' );
		$short_description = ( ! empty( $instance['short_description'] ) ) ? $instance['short_description'] : esc_html__( 'A design is plan or specification for the construction','gemas' );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_html__( 'Title:','gemas' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
		</p>
		<p>
	        <label for="<?php echo esc_attr($this->get_field_id( 'profile_image' )); ?>"><?php echo esc_html__( 'Profile image:','gemas' ); ?></label>
	    ...
	    <p>
			<label for="<?php echo esc_attr($this->get_field_id( 'designation' )); ?>"><?php echo esc_html__( 'Designation:','gemas' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'short_description' )); ?>"><?php echo esc_html__( 'Short description:','gemas' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php echo esc_html__( 'Facebook:','gemas' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'facebook' )); ?>" type="text" value="<?php echo esc_attr($facebook); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php echo esc_html__( 'Twitter:','gemas' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'twitter' )); ?>" type="text" value="<?php echo esc_attr($twitter); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php echo esc_html__( 'Pinterest:','gemas' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'pinterest' )); ?>" type="text" value="<?php echo esc_attr($pinterest); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>"><?php echo esc_html__( 'Linkedin:','gemas' ); ?></label>
...
function gemas_Author(){
	register_widget('gemas_Author');
}
add_action('widgets_init','gemas_Author');