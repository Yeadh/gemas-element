...
class gemas {
	...
	public function gemas_setup() {
		add_image_size( 'gemas-77x64', 77,64, true );
		add_image_size( 'gemas-100x75', 100,75, true );
	}
	...
	public function enqueue_scripts() {
		wp_register_style( 'gemas-plugin-style', plugin_dir_url( __FILE__ ) . 'public/assets/css/style.css' );
		wp_register_script( 'gemas-plugin-main-js', plugin_dir_url( __FILE__ ) . 'public/assets/js/main.js' );

		wp_enqueue_style( 'gemas-plugin-style' );
		wp_enqueue_script( 'gemas-plugin-main-js' );
	}

	public function admin_scripts() {
	    wp_enqueue_media();
	    wp_enqueue_script('gemas-admin-main-js', plugin_dir_url( __FILE__ ) . 'admin/assets/js/main.js', array('jquery'), wp_get_theme()->get( 'Version' ), true );
	}
